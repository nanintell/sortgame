...
<head>
  ...
  <title>Sort Algo Game | Admin System</title>
  ...
  <!-- jszip -->
  <script type="text/javascript" src="../resources/plugins/jszip/jszip.min.js"></script>
  <!-- css -->
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-12">
              <h1>Sorting Algorithm Game Admin System</h1>
            </div>
          </div>
        </div><!-- /.container-fluid -->
      </section>
